...
#Unit tests should test every single line of code (usually function by function)
...
def test_can_pick_winner_correctly():
    ...
    STATIC_RNG= 777
    #dummying of getting a response from the chainlink node, 777 is the number we will respond with
